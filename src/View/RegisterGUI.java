...
public class RegisterGUI extends JFrame {
	...
	public RegisterGUI() {
		...
		w_pane = new JPanel();
		w_pane.setBackground(Color.MAGENTA);
		...
		label.setBounds(38, 60, 66, 14);
		w_pane.add(label);

		fld_name = new JTextField();
		fld_name.setText("");
		fld_name.setColumns(10);
		fld_name.setBounds(114, 59, 170, 20);
		w_pane.add(fld_name);

		JLabel lblTcNumarasi = new JLabel("T.C. Numarasi");
		lblTcNumarasi.setForeground(Color.BLACK);
		lblTcNumarasi.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblTcNumarasi.setBounds(10, 106, 96, 14);
		w_pane.add(lblTcNumarasi);

		fld_tcno = new JTextField();
		fld_tcno.setText("");
		fld_tcno.setColumns(10);
		fld_tcno.setBounds(114, 105, 170, 20);
		w_pane.add(fld_tcno);

		JLabel lblSifre = new JLabel("Sifre");
		lblSifre.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblSifre.setBounds(73, 151, 31, 14);
		w_pane.add(lblSifre);

		fld_pass = new JPasswordField();
		fld_pass.setBounds(114, 149, 170, 23);
		w_pane.add(fld_pass);
		...
		btnRegister.setBounds(10, 216, 131, 54);
		w_pane.add(btnRegister);

		JButton btnBackto = new JButton("Geri Don");
		btnBackto.setBackground(Color.WHITE);
		...
		btnBackto.setBounds(155, 216, 131, 54);
