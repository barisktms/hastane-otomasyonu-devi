...
public class DoctorGUI extends JFrame {
	...
	public DoctorGUI(Doctor doctor) {
		...
		w_pane = new JPanel();
		w_pane.setBackground(new Color(255, 160, 122));
		...
		dateChooser.setBounds(10, 11, 140, 27);
		w_whour.add(dateChooser);

		JPanel w_appointments = new JPanel();
		w_appointments.setBackground(new Color(255, 160, 122));
