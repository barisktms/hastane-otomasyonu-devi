...
public class HastaGUI extends JFrame {
	...
	public HastaGUI(Hasta hasta) throws SQLException {
		...
		w_pane = new JPanel();
		w_pane.setBackground(new Color(173, 255, 47));
		...
		select_Clinic.setForeground(Color.WHITE);
		select_Clinic.setBackground(new Color(0, 0, 0));
		...
		w_appoint.setBackground(new Color(173, 255, 47));
