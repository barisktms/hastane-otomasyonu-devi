...
public class LoginGUI extends JFrame {
	...
	public LoginGUI() {
		...
		w_pane = new JPanel();
		w_pane.setBackground(Color.GREEN);
		...
		JLabel lblHastaneYnetimSistemine = new JLabel("Giriş Ekranına Hoşgeldiniz");
		lblHastaneYnetimSistemine.setFont(new Font("Verdana", Font.BOLD, 17));
		lblHastaneYnetimSistemine.setBounds(121, 132, 250, 22);
		...
		lblTcGirisi.setForeground(Color.RED);
		lblTcGirisi.setBackground(Color.WHITE);
		...
		btn_hastaLogin.setForeground(Color.WHITE);
		btn_hastaLogin.setBackground(Color.BLACK);
		...
		w_doctorLogin.setBackground(Color.LIGHT_GRAY);
		w_tabpane.addTab("Yetkili Girisi", null, w_doctorLogin, null);
		...
		btn_doktorLogin.setForeground(Color.WHITE);
		btn_doktorLogin.setBackground(Color.BLACK);
